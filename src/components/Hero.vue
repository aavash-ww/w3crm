    ...
    <div class="slider">
        <div class="slider__text">
            ...
            <div class="slider__text__buttongrp">
                ...
                <div class="slider__text__buttongrp__2">Contact sales</div>
            </div>
            <small>Full access. No credit card required. Used by over 100 companies.</small>
        </div>
        <div class="slider__image">
            <img src="../assets/images/slider_img.png" alt="">
        </div>
    </div>
</template>